# Research Sources: Webinar Funnel Experts

This document lists the 10 experts analyzed for this project. It includes their roles, relevance to the webinar funnel ecosystem, and the specific sources used for data extraction via API.

| Expert | Role / Title | Webinar Relevance | Source Link | Date Accessed |
| :--- | :--- | :--- | :--- | :--- |
| **Russell Brunson** | CEO of ClickFunnels | Architect of the "Perfect Webinar" script and funnel psychology. | [Video](https://www.youtube.com/watch?v=QHfnc6MB6l4) | April 17, 2026 |
...
| **Casey Zeman** | Founder of EasyWebinar | Pioneer in evergreen webinar software and technical automation systems. | [Video](https://www.youtube.com/watch?v=Eof8Z7p_zwQ) | April 17, 2026 |
| **Miles Beckler** | Founder of MilesBeckler.com | Advocate for "Bootstrap" marketing; expert in low-cost funnel infrastructure. | [Video](https://www.youtube.com/watch?v=DiqqGGwkfHE) | April 17, 2026 |

### Brief Annotations
* **Strategy:** The research spans from technical setup (Zeman) to psychological triggers (Brunson/Fladlien).
* **Traffic:** A mix of paid (Penberthy/Anne) and organic (Patel/Welsh) ensures a sustainable "from zero" approach.
* **Retention:** McGarry and Porterfield provide the necessary post-webinar nurturing insights.